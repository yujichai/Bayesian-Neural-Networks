...
parser = argparse.ArgumentParser(description='Train Bayesian Neural Net on MNIST with Deterministic Model')
...
parser.add_argument('--models_dir', type=str, nargs='?', action='store', default='Deterministic_models',
                    help='Where to save learnt weights and train vectors. Default: \'Deterministic_models\'.')
parser.add_argument('--results_dir', type=str, nargs='?', action='store', default='Deterministic_results',
                    help='Where to save learnt training plots. Default: \'Deterministic_results\'.')
